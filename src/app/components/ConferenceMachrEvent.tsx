    ...
    <div className="conference-event-container">
      <div className="conference-event-text">
        ...
        <p className="conference-description">
          ...
          ресурси кои ќе помогнат на организациите да станат &quot;future
          fit&quot;. Оваа конференција ќе ги собере најдобрите умови и лидери во
          HR за да дискутираат и разменат идеи на прогресивни стратегии кои
          можат да ја трансформираат работната сила и да ја зголемат
